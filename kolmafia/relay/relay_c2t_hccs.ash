...
void main() {
	...
	string [string] disableable = {
		...
		"c2t_hccs_disable.synthesisItem":"will not get the item drop buff from sweet synthesis",
		...
		"c2t_hccs_disable.vipFortuneBuff":"will not get the item drop buff from the vip fortune teller",
	...
	c2t_hccs_writeSelect("c2t_hccs_workshed","workshed to be installed and used",$items[none,asdon martin keyfob (on ring),cold medicine cabinet,diabolic pizza cube,model train set]);
	write("</tbody></table>");
